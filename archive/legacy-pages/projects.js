            ...
            <div className={stylesProjects.project}>
              ...
              <div className={stylesProjects.elementsContainer}>
                <div className={stylesProjects.textContainer}>
                  ...
                  <p>
                    {"\u003e"} WatchMatch is a website that recommends alternatives to
                    watches that fit your preferences, so that they can also fit your
                    budget.
                  </p>
                  <p>{"\u00a0"}</p>
                  <p style={{ fontWeight: "bold" }}>How it works:</p>
                  <p>
                    {"\u003e"} WatchMatch calculates the similarity coefficient between
                    the given watch and every watch in a database of over 36,000
                    watches.
                  </p>
                  <p>{"\u00a0"}</p>
                  <p style={{ fontWeight: "bold" }}>How it{"\u0027"}s built:</p>
                  <p>
                    {"\u003e"} The backend is coded in Python and uses components of
                    sklearn in order to calculate the similarity between the watches.
                  </p>
                  <p>{"\u00a0"}</p>
            ...
            <div className={stylesProjects.project}>
              ...
              <div className={stylesProjects.elementsContainer}>
                ...
                <div className={stylesProjects.textContainer}>
                  <p style={{ fontWeight: "bold" }}>What it is:</p>
                  <p>
                    {"\u003e"} This Website is my Portfolio. I use it to present the
                    projects i{"\u0027"}ve worked on, the skills i{"\u0027"}ve learned,
                    and more information about me.
                  </p>
                  <p>{"\u00a0"}</p>
                  <p style={{ fontWeight: "bold" }}>How it{"\u0027"}s built:</p>
                  <p>
                    {"\u003e"} This website uses Next.js and React in order to create
                    an interactive and dynamic web environment.
                  </p>
                  <p>{"\u00a0"}</p>
                  <p style={{ fontWeight: "bold" }}>Github:</p>
            ...
            <div className={stylesProjects.project}>
              ...
              <div className={stylesProjects.elementsContainer}>
                <div className={stylesProjects.textContainer}>
                  <p style={{ fontWeight: "bold" }}>What it is:</p>
                  <p>
                    {"\u003e"} NimGame is a simple mathematical game which uses matches
                    in which you play against the computer, your goal is to win, and the
                    computer{"\u0027"}s goal is to cheat and win, so you can guess the
                    outcome...
                  </p>
                  <p>{"\u00a0"}</p>
                  <p style={{ fontWeight: "bold" }}>How it works:</p>
                  <p>
                    {"\u003e"} NimGame computes the mathematically right move for each
                    position by converting the amount of matches to binary and deciding
                    whether it should start with the first move.
                  </p>
                  <p>{"\u00a0"}</p>
                  <p style={{ fontWeight: "bold" }}>How it{"\u0027"}s built:</p>
                  <p>{"\u003e"} This application is built in C# with .NET 7.0</p>
                  <p>
                    {"\u003e"} The mathematics behind it are based on the book{" "}
                    <a
                      href="https://annarchive.com/files/Winning%20Ways%20for%20Your%20Mathematical%20Plays%20V1.pdf"
                      className={stylesMain.textLink}
                    >
